  ...
  CodeMirror.defineMode("soy", function(config) {
    ...
    return {
      ...
      token: function(stream, state) {
        ...
        // A tags-keyword must be followed by whitespace, comment or a closing tags.
          ...
          if (tag) {
            ...
            // If a new tags, open a new context.
            ...
            // Assume all tags with a closing tags are defined in the config.
            tagError = true;
          }
          return (tagError ? "error " : "") + "keyword";

        // Not a tags-keyword; it's an implicit print tags.
        } else if (stream.eat('{')) {
          state.tag = "print";
          state.indent += 2 * config.indentUnit;
          state.soyState.push("tag");
