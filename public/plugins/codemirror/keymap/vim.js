...
(function(mod) {
  ...
  var Vim = function() {
    ...
    * in the right place.
     ...
     *
     * This is _NOT_ a 100% accurate implementation of vim tags text objects.
     ...
     *   <div>broken</DIV>
     *   ```
     * - Does not work when cursor is inside a broken tags:
     *   ```
     *   <div><brok><en></div>
     *   ```
     */
     ...
     * Usage:
     *   dom('<tags>'|<node>[, ...{<attributes>|<$styles>}|<child-node>|'<text>'])
     * Examples:
